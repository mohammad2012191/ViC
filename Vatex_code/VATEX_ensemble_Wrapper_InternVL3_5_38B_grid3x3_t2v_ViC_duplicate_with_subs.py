...
import numpy as np
import pandas as pd
from VATEX_ensemble_InternVL3_5_38B_grid3x3_t2v_ViC_duplicate_with_subs import run_distributed_inference
from VATEX_ensemble_InternVL3_5_38B_grid3x3_t2v_ViC_duplicate_with_subs import Config
...
def main():
    ...
    sim_paths = [
                # "InternVideo/InternVideo2/multi_modality/sim_TxV.npy",
                 ...
                 # "similarity_matrices/GRAM_activitynet.npy",
