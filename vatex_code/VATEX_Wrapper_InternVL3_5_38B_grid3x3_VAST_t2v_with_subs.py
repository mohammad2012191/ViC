...
import numpy as np
import pandas as pd
from VATEX_InternVL3_5_38B_grid3x3_VAST_t2v_with_subs import run_distributed_inference
from VATEX_InternVL3_5_38B_grid3x3_VAST_t2v_with_subs import Config
...
def main():
    ...
    sim_path = "VAST_vatex_final.npy"  # NxN similarity matrix
