...
import numpy as np
import pandas as pd
from InternVL3_5_38B_grid4x4_GRAM_didemo_t2v import run_distributed_inference
from InternVL3_5_38B_grid4x4_GRAM_didemo_t2v import Config
...
def main():
    ...
    sim_path = "GRAM_didemo_tv.npy"  # NxN similarity matrix
