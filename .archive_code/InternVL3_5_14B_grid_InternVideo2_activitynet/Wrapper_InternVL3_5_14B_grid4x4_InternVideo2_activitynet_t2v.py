...
import numpy as np
import pandas as pd
from InternVL3_5_14B_grid4x4_InternVideo2_activitynet_t2v import run_distributed_inference
from InternVL3_5_14B_grid4x4_InternVideo2_activitynet_t2v import Config
...
def main():
    ...
    sim_path = "InternVideo2_activitynet.npy"  # NxN similarity matrix
