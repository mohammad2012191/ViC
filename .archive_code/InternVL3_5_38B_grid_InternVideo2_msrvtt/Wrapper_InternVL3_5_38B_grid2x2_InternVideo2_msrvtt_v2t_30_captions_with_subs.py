...
import numpy as np
import pandas as pd
from InternVL3_5_38B_grid2x2_InternVideo2_msrvtt_v2t_30_captions_with_subs import run_distributed_inference
from InternVL3_5_38B_grid2x2_InternVideo2_msrvtt_v2t_30_captions_with_subs import Config
...
def main():
    ...
    ##################################################
    csv_path = "descs_ret_test_msrvtt.csv"  # The CSV with columns: key, vid_key, video_id, sentence
    # sim_path = "sim_matrix_clip4clip.npy"  # NxN similarity matrix
    # sim_path = "sim_matrix_Vast_tvas.npy"  # NxN similarity matrix
    sim_path = "InternVideo2_msrvtt.npy"  # NxN similarity matrix
