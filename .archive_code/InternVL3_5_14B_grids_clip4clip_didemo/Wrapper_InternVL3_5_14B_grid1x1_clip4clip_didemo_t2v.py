...
import numpy as np
import pandas as pd
from InternVL3_5_14B_grid1x1_clip4clip_didemo_t2v import run_distributed_inference
from InternVL3_5_14B_grid1x1_clip4clip_didemo_t2v import Config
...
def main():
    ...
    sim_path = "clip4clip_didemo.npy"  # NxN similarity matrix
    ...
    if sim_matrix.shape[0] != N:
        print(f"{sim_matrix.shape[0]} a7a")
        print(f"{N} a7ateen")
