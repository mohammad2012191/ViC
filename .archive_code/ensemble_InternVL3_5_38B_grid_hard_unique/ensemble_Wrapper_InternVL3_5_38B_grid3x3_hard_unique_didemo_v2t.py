...
import numpy as np
import pandas as pd
from ensemble_InternVL3_5_38B_grid3x3_hard_unique_didemo_v2t import run_distributed_inference
from ensemble_InternVL3_5_38B_grid3x3_hard_unique_didemo_v2t import Config
...
def main():
    ...
    sim_paths = ["clip4clip_didemo.npy",
                 #"VAST_didemo.npy",
                 "GRAM_didemo_tv.npy",
                 "InternVideo2_didemo.npy"] # pass list via env or CLI
