...
import numpy as np
import pandas as pd
from InternVL3_5_14B_grid4x4_GRAM_activitynet_v2t import run_distributed_inference
from InternVL3_5_14B_grid4x4_GRAM_activitynet_v2t import Config
...
def main():
    ...
    sim_path = "GRAM_activitynet_tva.npy"  # NxN similarity matrix
