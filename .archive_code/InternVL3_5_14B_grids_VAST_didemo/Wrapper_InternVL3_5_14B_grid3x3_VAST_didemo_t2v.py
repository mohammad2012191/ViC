...
import numpy as np
import pandas as pd
from InternVL3_5_14B_grid3x3_VAST_didemo_t2v import run_distributed_inference
from InternVL3_5_14B_grid3x3_VAST_didemo_t2v import Config
...
def main():
    ...
    sim_path = "VAST_didemo.npy"  # NxN similarity matrix
