...
import numpy as np
import pandas as pd
from InternVL3_5_38B_grid3x3_VAST_msrvtt_v2t_with_subs import run_distributed_inference
from InternVL3_5_38B_grid3x3_VAST_msrvtt_v2t_with_subs import Config
...
def main():
    ...
    sim_path = "VAST_msrvtt.npy"  # NxN similarity matrix
