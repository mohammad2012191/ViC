...
import numpy as np
import pandas as pd
from InternVL3_5_38B_grid2x2_clip4clip_activitynet_t2v import run_distributed_inference
from InternVL3_5_38B_grid2x2_clip4clip_activitynet_t2v import Config
...
def main():
    ...
    sim_path = "clip4clip_activitynet.npy"  # NxN similarity matrix
