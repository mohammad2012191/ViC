...
import pandas as pd
import argparse
from msrvtt_activitynet_didemo_t2v import run_distributed_inference
from msrvtt_activitynet_didemo_t2v import Config
...
def parse_args():
    parser = argparse.ArgumentParser(description='Run distributed text-to-video inference')
    ...
    parser.add_argument('--num_images', type=int, default=14,
                        help='Number of videos to select from similarity row (default: 14)')
    ...
    parser.add_argument('--grid_size', type=int, default=2,
                        help='Grid size for frame sampling (default: 2 for 2x2 grid)')
