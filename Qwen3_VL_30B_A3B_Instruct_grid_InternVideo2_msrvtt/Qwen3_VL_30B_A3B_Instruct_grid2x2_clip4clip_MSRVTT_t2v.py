...
class VLMWorker:
    ...
    def rerank_top_videos(self, query_text, video_paths):
        ...
        fetch first frames and use Qwen3-VL to rerank.
        """
        ...
        for i, vid_path in enumerate(video_paths):
            ...
            content.append({
                "type": "image",
                "image": img  # Qwen3-VL accepts PIL Images directly
            })
            content.append({
                "type": "text",
                "text": f"Image-{i+1}"
        ...
        content.append({
            ...
            # f"If you return an empty list explain why."
            )
        })
    ...
    def parse_ranking_from_response(self, response_text, num_images):
        ...
        # print(f'model response is {response_text}')
        if match:
