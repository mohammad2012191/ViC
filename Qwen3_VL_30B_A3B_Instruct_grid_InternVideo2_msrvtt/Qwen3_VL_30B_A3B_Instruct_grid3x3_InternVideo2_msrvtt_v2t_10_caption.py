...
#####################################################
class Config:
    num_captions = 10  # how many text candidates we select from the similarity row
    video_dir = "MSRVTT"
...
class VLMWorker:
    ...
    def rerank_top_captions(self, query_patches, text_candidates):
        ...
        messages = [
            {
                ...
                "content": [
                    {
                        "type": "image",
                        "image": query_patches,  # Pass the tensor directly
                    },
        ...
        # parse the new ranking (same as before)
